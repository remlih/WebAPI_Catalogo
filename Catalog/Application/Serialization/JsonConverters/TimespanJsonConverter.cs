...
namespace Catalog.Application.Serialization.JsonConverters
{
    /// <summary>
    ...
    public class TimespanJsonConverter : JsonConverter<TimeSpan>
    {
        ...
        public override TimeSpan Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            {
                throw new FormatException($"El dato ingresado no tiene el formato esperado : {Regex.Unescape(TimeSpanFormatString)}. Analíce la cadena manualmente.");
            }
