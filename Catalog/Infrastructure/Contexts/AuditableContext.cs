...
{
    public abstract class AuditableContext : IdentityDbContext<CatalogUser, CatalogRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, CatalogRoleClaim, IdentityUserToken<string>>
    {
