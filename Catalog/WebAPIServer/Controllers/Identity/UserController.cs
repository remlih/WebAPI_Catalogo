...
namespace Catalog.WebAPIServer.Controllers.Identity
{
    [Authorize]
    ...
    public class UserController : ControllerBase
    {
        ...
        /// <summary>
        /// Get FullName User By Id
        /// </summary>
        /// <param name="id"></param>
        /// <returns>Status 200 OK</returns>
        [Authorize(Policy = Permissions.Users.View)]
        [HttpGet("fullname/{id}")]
        public async Task<IActionResult> GetFullNameById(string id)
        {
            var userFullName = await _userService.GetFullNameAsync(id);
