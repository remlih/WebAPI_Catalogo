...
using Catalog.Application.Features.Brands.Commands.Delete;
using Catalog.Application.Features.Brands.Queries.Export;
...
namespace Catalog.WebAPIServer.Controllers.v1.Catalog
{
    public class BrandsController : BaseApiController<BrandsController>
    {
        ...
        [HttpPut]
        public async Task<IActionResult> Put(AddEditBrandCommand command)
        {
            return Ok(await _mediator.Send(command));
        }
