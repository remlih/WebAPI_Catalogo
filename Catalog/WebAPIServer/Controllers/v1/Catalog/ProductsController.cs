...
using Catalog.Application.Features.Products.Queries.Export;
using Catalog.Application.Features.Products.Queries.GetAllPaged;
using Catalog.Application.Features.Products.Queries.GetProductImage;
...
namespace Catalog.WebAPIServer.Controllers.v1.Catalog
{
    public class ProductsController : BaseApiController<ProductsController>
    {
        ...
        [HttpPut]
        public async Task<IActionResult> Put(AddEditProductCommand command)
        {
            return Ok(await _mediator.Send(command));
        }
