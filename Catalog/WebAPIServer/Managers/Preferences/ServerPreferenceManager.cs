...
using Catalog.Shared.Constants.Storage;
    ...
    public class ServerPreferenceManager : IServerPreferenceManager
    {
        ...
        public async Task<Shared.Wrapper.IResult> ChangeLanguageAsync(string languageCode)
        {
            ...
            if (preference != null)
            {
                ...
                {
                    Succeeded = true,
                    Messages = new List<string> { _localizer["Se ha cambiado el idioma del servidor"] }
                };
            }
            ...
            {
                Succeeded = false,
                Messages = new List<string> { _localizer["Error al obtener las preferencias del servidor"] }
            };
        }
